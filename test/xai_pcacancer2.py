...
model="../ph_pipeline/Model/weights_binary_cancer_resnet50_2.h5"
store= "../../../DATA/cancer/xai/cancerR/"
point=[1,39]
# run train of main segmentation
mn.xai(image,model,store,point,model_name='resnet50',height=512,width=512,channels=3,classes=2,case='binary_cancer',batch=1,label=[1,0],rot=180,backbone="none",pca='on')

mn1=main.main('binary_cancer',["normal","cancer"])
image1= "../../../DATA/cancer/2/"              #Copy of BJRas2_c1_23.tif"
model1="../ph_pipeline/Model/weights_binary_cancer_resnet50_2.h5"
store1= "../../../DATA/cancer/xai/normalR/"
point1=[1,39]
# run train of main segmentation
mn1.xai(image1,model1,store1,point1,model_name='resnet50',height=512,width=512,channels=3,classes=2,case='binary_cancer',batch=1,label=[0,1],rot=180,backbone="none",pca='on')
