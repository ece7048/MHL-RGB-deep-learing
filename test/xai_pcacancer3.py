...
model="../ph_pipeline/Model/weights_binary_cancer_DENRES.h5"
store= "../../../DATA/cancer/xai/cancerD/"
point=[1,8]
# run train of main segmentation
mn.xai(image,model,store,point,model_name='DENRES',height=512,width=512,channels=1,classes=2,case='binary_cancer',batch=1,label=[1,0],rot=180,backbone="none",pca='on',input_n=7)

mn1=main.main('mhl_cancer',["normal","cancer"])
image1= "../../../DATA/cancer/2/"              #Copy of BJRas2_c1_23.tif"
model1="../ph_pipeline/Model/weights_binary_cancer_DENRES.h5"
store1= "../../../DATA/cancer/xai/normalD/"
point1=[1,8]
# run train of main segmentation
mn1.xai(image1,model1,store1,point1,model_name='DENRES',height=512,width=512,channels=1,classes=2,case='binary_cancer',batch=1,label=[0,1],rot=180,backbone="none",pca='on',input_n=7)
